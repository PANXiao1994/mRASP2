...
import numpy as np
from .sampled_multi_dataset_new import SampledMultiDatasetNew

from fairseq.data.multilingual.sampled_multi_dataset import CollateFormat, default_virtual_size_func
from fairseq.data import plasma_utils

logger = logging.getLogger(__name__)


class SampledMultiEpochDatasetNew(SampledMultiDatasetNew):
    ...
    def _map_epoch_index_to_global(self, index):
        ...
        # add randomness
        return self._random_global_indices.array[index]
    ...
    def sizes(self):
        ...
        _sizes = super().sizes
        indices = self._random_global_indices.array[
    ...
    def _next_global_indices(self, epoch):
        ...
        self._random_global_indices = plasma_utils.PlasmaArray(
            rng.choice(
